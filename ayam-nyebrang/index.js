...
const firstRun = () =>{
    document.getElementById("instructions").innerText = ((/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) ? "Geser Jari Anda Untuk Bergerak" : "Gunakan Tanda Panah Untuk Bergerak.") + "\nBantuin Ayam Nya Nyebrang,Kasian Jir";
    stats = new Stats();
    stats.showPanel(0);
