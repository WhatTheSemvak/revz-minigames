...
const startGame = () => {
    swal({
        ...
        text: (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) ? 'Geser Ke Atas/Bawah/Kiri/Kanan Untuk Bergerak\n\nGame Design: Revz' : 'Gunakan tanda panah di keyboard untuk bergerak\nGame Design: Revz',
        button: "Play!",
